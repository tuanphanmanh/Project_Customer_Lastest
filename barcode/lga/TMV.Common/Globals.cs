...
namespace TMV.Common
{
    public class Globals
    {
        ...
        //W1
        public static int IndexUUW1;
        public static int IndexUFW1;
        public static int IndexUAAW1;
        public static int IndexSWLW1;
        public static int IndexSWRW1 ;
        public static int IndexSMALW1;
        public static int IndexSMARW1;
        public static int IndexRoofCallW1;
        public static int IndexMBACfW1;
        //W2
        public static int IndexUUW2;
        public static int IndexUFW2;
        public static int IndexUAAW2;
        public static int IndexSWLW2 ;
        public static int IndexSWRW2;
        public static int IndexSMALW2;
        public static int IndexSMARW2;
        public static int IndexRoofCallW2 ;
        public static int IndexMBACfW2;
        //Combine W
        public static int IndexMBACallW1;
        public static int IndexMBACallW2;
        public static int IndexMBAReset;
        public static int IndexFT;   //Logistics part call
        //LW1
        public static int IndexCfUUUFW1;
        public static int IndexCfUAAW1;
        public static int IndexCfSWW1;
        public static int IndexCfSMACfW1B1;
        public static int IndexCfSMACfW1B2;
        public static int IndexCfRoofW1 ;
        //LW2
        public static int IndexCfUUUFW2 ;
        public static int IndexCfUAAW2 ;
        public static int IndexCfSWW2 ;
        public static int IndexCfSMACfW2B1 ;
        public static int IndexCfSMACfW2B2;
        public static int IndexCfRoofW2 ;
        //FT
        public static int IndexFN ;
        #endregion
