...
using esign.MultiTenancy.HostDashboard;
...
namespace esign.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(esignDbContext context, SubscriptionPayment subscriptionPayment)
        {
