...
using prod.Mobile.MAUI.Services.Account;
using prod.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using prod.Mobile.MAUI.Services.Tenants;

#if ANDROID
using prod.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace prod.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new prod.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
