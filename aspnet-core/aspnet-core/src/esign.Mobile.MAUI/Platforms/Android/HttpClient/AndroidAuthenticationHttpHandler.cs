...
namespace prod.Mobile.MAUI.Platforms.Android.HttpClient
{
    internal sealed class AndroidAuthenticationHttpHandler : Xamarin.Android.Net.AndroidMessageHandler
    {
        ...
        // Copy of prod.ApiClient.AuthenticationHttpHandler for android override
        // -----------------------------
        ...
        // End of Copy of prod.ApiClient.AuthenticationHttpHandler for android override
        // -----------------------------
    }
}
