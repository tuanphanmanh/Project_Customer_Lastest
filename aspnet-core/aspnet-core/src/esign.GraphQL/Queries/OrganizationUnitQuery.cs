...
using esign.Core.Base;
using esign.Core.Extensions;
using esign.Dto;
using esign.Types;

namespace esign.Queries
{
    public class OrganizationUnitQuery : esignQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
