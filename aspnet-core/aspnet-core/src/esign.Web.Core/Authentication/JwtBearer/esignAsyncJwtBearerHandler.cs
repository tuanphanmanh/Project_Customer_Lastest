...
{
    public class esignAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public esignAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
