...
{
    public class SubscriptionPaymentExtensionDataRepository : esignRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<esignDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
