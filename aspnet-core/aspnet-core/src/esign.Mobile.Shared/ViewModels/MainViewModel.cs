...
using prod.Controls;
using prod.Dto;
using prod.Extensions;
using prod.Localization;
using prod.UI;
using prod.UI.Assets;
using prod.Views;
using DependencyResolver = prod.Core.Dependency.DependencyResolver;

namespace prod.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "prod";
