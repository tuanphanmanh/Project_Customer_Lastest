...
{
    [AbpAuthorize]
    [AbpAuthorize(AppPermissions.Pages_UserDelegation)]
    public class UserDelegationAppService : esignVersion1AppServiceBase, IUserDelegationAppService
    {
        ...
        [HttpGet]
        public async Task<PagedResultDto<UserDelegationDto>> GetDelegatedUsers([FromQuery]GetUserDelegationsInput input)
        {
        ...
        [HttpPost]
        public async Task RemoveDelegation([FromQuery]EntityDto<long> input)
        {
            CheckUserDelegationOperation();
