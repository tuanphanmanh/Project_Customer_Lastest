...
namespace esign.Authorization.Roles.Ver1
{
    ...
    public class RoleAppService : esignVersion1AppServiceBase, IRoleAppService
    {
        ...
        [HttpPost]
        [AbpAuthorize(AppPermissions.Pages_Administration_Roles_GetRoles)]
        ...
        public async Task<GetRoleForEditOutput> GetRoleForEdit([FromQuery] NullableIdDto input)
        {
        ...
        [HttpPost]
        [AbpAuthorize(AppPermissions.Pages_Administration_Roles_Edit, AppPermissions.Pages_Administration_Roles_Create)]
        ...
        [HttpPost]
        public async Task DeleteRole([FromQuery] EntityDto input)
        {
