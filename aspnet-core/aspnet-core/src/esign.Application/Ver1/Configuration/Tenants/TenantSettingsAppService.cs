...
namespace esign.Configuration.Tenants.Ver1
{
    ...
    public class TenantSettingsAppService : Configuration.Ver1.SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (!await IsTwoFactorLoginEnabledForApplicationAsync()) //Two factor login can not be used by tenants if disabled by the host
            {
                return;
            }
