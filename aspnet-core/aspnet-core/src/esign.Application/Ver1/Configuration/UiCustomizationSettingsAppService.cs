...
{
    [AbpAuthorize]
    [AbpAuthorize(AppPermissions.Pages_UiCustomizationSettings)]
    public class UiCustomizationSettingsAppService : esignVersion1AppServiceBase, IUiCustomizationSettingsAppService
    {
