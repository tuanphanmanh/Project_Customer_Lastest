...
namespace esign.Organizations.Ver1
{
    [AbpAuthorize]
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : esignVersion1AppServiceBase, IOrganizationUnitAppService
    {
        ...
        [HttpGet]
        [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits_GetOrganizationUnits)]
        ...
        [HttpGet]
        [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits_GetOrganizationUnitUsers)]

        public async Task<PagedResultDto<OrganizationUnitUserListDto>> GetOrganizationUnitUsers(
            [FromQuery] GetOrganizationUnitUsersInput input)
        {
        ...
        [HttpGet]
        [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits_GetOrganizationUnitRoles)]

        public async Task<PagedResultDto<OrganizationUnitRoleListDto>> GetOrganizationUnitRoles(
            [FromQuery] GetOrganizationUnitRolesInput input)
        {
        ...
        [HttpPost]
        public async Task RemoveUserFromOrganizationUnit([FromQuery] UserToOrganizationUnitInput input)
        {
        ...
        [HttpPost]
        public async Task RemoveRoleFromOrganizationUnit([FromQuery] RoleToOrganizationUnitInput input)
        {
        ...
        [HttpGet]
        [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits_GetAll)]
