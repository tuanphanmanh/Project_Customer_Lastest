...
{
    [AbpAuthorize(AppPermissions.Pages_DashboardCustomization)]
    public class DashboardCustomizationAppService : esignVersion1AppServiceBase, IDashboardCustomizationAppService
    {
        ...
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_GetUserDashboard)]
        [HttpGet]
        public async Task<Dashboard> GetUserDashboard([FromQuery] GetDashboardInput input)
        {
            return await GetDashboardWithAuthorizedWidgets(input.Application, input.DashboardName);
        }
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_SavePage)]
        [HttpPost]
        ...
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_RenamePage)]
        [HttpPost]
        ...
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_AddNewPage)]
        [HttpPost]
        ...
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_DeletePage)]
        [HttpPost]
        public async Task DeletePage([FromQuery] DeletePageInput input)
        {
            var dashboard = await GetDashboardWithAuthorizedWidgets(input.Application, input.DashboardName);
        ...
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_AddWidget)]
        [HttpPost]
        ...
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_GetDashboardDefinition)]
        [HttpGet]
        public DashboardOutput GetDashboardDefinition([FromQuery] GetDashboardInput input)
        {
        ...
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_GetAllWidgetDefinitions)]
        [HttpGet]
        public List<WidgetOutput> GetAllWidgetDefinitions([FromQuery] GetDashboardInput input)
        {
            var dashboardDefinition =
                _dashboardConfiguration.DashboardDefinitions.FirstOrDefault(d => d.Name == input.DashboardName);
            if (dashboardDefinition == null)
        ...
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_GetAllAvailableWidgetDefinitionsForPage)]
        [HttpGet]
        public async Task<List<WidgetOutput>> GetAllAvailableWidgetDefinitionsForPage(
            [FromQuery] GetAvailableWidgetDefinitionsForPageInput input)
        {
            var dashboardDefinition =
                _dashboardConfiguration.DashboardDefinitions.FirstOrDefault(d => d.Name == input.DashboardName);
            if (dashboardDefinition == null)
        ...
        [AbpAuthorize(AppPermissions.Pages_DashboardCustomization_GetSettingName)]
        [HttpGet]
