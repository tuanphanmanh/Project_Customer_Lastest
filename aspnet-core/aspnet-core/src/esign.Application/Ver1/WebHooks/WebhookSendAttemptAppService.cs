...
namespace esign.WebHooks.Ver1
{
    ...
    public class WebhookSendAttemptAppService : esignVersion1AppServiceBase, IWebhookAttemptAppService
    {
        ...
        [HttpGet]
        public async Task<PagedResultDto<GetAllSendAttemptsOutput>> GetAllSendAttempts([FromQuery] GetAllSendAttemptsInput input)
        {
        ...
        [HttpGet]
        public async Task<ListResultDto<GetAllSendAttemptsOfWebhookEventOutput>> GetAllSendAttemptsOfWebhookEvent([FromQuery] GetAllSendAttemptsOfWebhookEventInput input)
        {
