...
using esign.Ver1.Editions;

namespace esign.Editions.Ver1
{
    [AbpAuthorize(AppPermissions.Pages_Edition)]
    public class EditionAppService : esignVersion1AppServiceBase, IEditionAppService
    {
        ...
        [HttpGet]
        [AbpAuthorize(AppPermissions.Pages_Edition_GetEditions)]
        ...
        [HttpGet]
        [AbpAuthorize(AppPermissions.Pages_Edition_GetEditionForEdit)]
        ...
        [HttpPost]
        [AbpAuthorize(AppPermissions.Pages_Edition_CreateEdition)]
        ...
        [HttpPost]
        [AbpAuthorize(AppPermissions.Pages_Edition_UpdateEdition)]
        ...
        [HttpPost]
        [AbpAuthorize(AppPermissions.Pages_Edition_DeleteEdition)]

        public async Task DeleteEdition([FromQuery] EntityDto input)
        {
        ...
        [HttpPost]
        [AbpAuthorize(AppPermissions.Pages_Edition_MoveTenantsToAnotherEdition)]
        ...
        [HttpGet]
        [AbpAuthorize(AppPermissions.Pages_Edition_GetEditionComboboxItems)]

        public async Task<List<SubscribableEditionComboboxItemDto>> GetEditionComboboxItems([FromQuery]int? selectedEditionId = null, [FromQuery] bool addAllItem = false, [FromQuery] bool onlyFreeItems = false)
        {
        ...
        [HttpGet]
        [AbpAuthorize(AppPermissions.Pages_Edition_GetTenantCount)]
