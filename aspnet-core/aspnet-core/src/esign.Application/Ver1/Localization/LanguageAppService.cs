...
using esign.Ver1.Localization;
using Microsoft.AspNetCore.Mvc;

namespace esign.Localization.Ver1
{
    [AbpAuthorize(AppPermissions.Pages_Administration_Languages)]
    public class LanguageAppService : esignVersion1AppServiceBase, ILanguageAppService
    {
        ...
        [HttpPost]
        public async Task DeleteLanguage([FromQuery] EntityDto input)
        {
        ...
        [HttpGet]
        public async Task<PagedResultDto<LanguageTextListDto>> GetLanguageTexts([FromQuery] GetLanguageTextsInput input)
        {
