...
using esign.Configuration.Ver1;
...
namespace esign.Install.Ver1
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : esignVersion1AppServiceBase, IInstallAppService
    {
        ...
        [HttpPost]
        [AbpAuthorize(AppPermissions.Pages_Install_Setup)]
        ...
        [HttpGet]
        [AbpAuthorize(AppPermissions.Pages_Install_GetAppSettingsJson)]
        ...
        [HttpPost]
        [AbpAuthorize(AppPermissions.Pages_Install_CheckDatabase)]
