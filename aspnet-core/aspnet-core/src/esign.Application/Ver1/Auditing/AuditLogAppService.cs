...
using esign.Auditing.Exporting.Ver1;
...
namespace esign.Auditing.Ver1
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : esignVersion1AppServiceBase, IAuditLogAppService
    {
        ...
        #region audit logs
        [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs_GetAuditLogs)]
        [HttpGet]
        public async Task<PagedResultDto<AuditLogListDto>> GetAuditLogs([FromQuery] GetAuditLogsInput input)
        {
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs_GetAuditLogsToExcel)]
        [HttpGet]
        public async Task<FileDto> GetAuditLogsToExcel([FromQuery] GetAuditLogsInput input)
        {
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs_GetEntityHistoryObjectTypes)]
        [HttpGet]
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs_GetEntityChanges)]
        [HttpGet]
        public async Task<PagedResultDto<EntityChangeListDto>> GetEntityChanges([FromQuery] GetEntityChangeInput input)
        {
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs_GetEntityTypeChanges)]
        [HttpGet]
        public async Task<PagedResultDto<EntityChangeListDto>> GetEntityTypeChanges([FromQuery]GetEntityTypeChangeInput input)
        {
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs_GetEntityChangesToExcel)]
        [HttpGet]
        public async Task<FileDto> GetEntityChangesToExcel([FromQuery] GetEntityChangeInput input)
        {
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs_GetEntityPropertyChanges)]
        [HttpGet]
