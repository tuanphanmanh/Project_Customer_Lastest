...
{
    [AbpAuthorize]
    [AbpAuthorize(AppPermissions.Pages_Administration_TenantRegistration)]
    public class TenantRegistrationAppService : esignVersion1AppServiceBase, ITenantRegistrationAppService
    {
