...
{
    public class PaymentAppService : esignVersion1AppServiceBase, IPaymentAppService
    {
        ...
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_GetPaymentInfo)]

        //public async Task<PaymentInfoDto> GetPaymentInfo([FromQuery] PaymentInfoInput input)
        //{
        ...
        //[HttpPost]
        //[AbpAuthorize(AppPermissions.Pages_Payment_CreatePayment)]
        ...
        //[HttpPost]
        //[AbpAuthorize(AppPermissions.Pages_Payment_CancelPayment)]
        ...
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_GetPaymentHistory)]

        //public async Task<PagedResultDto<SubscriptionPaymentListDto>> GetPaymentHistory([FromQuery] GetPaymentHistoryInput input)
        //{
        ...
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_GetActiveGateways)]

        //public List<PaymentGatewayModel> GetActiveGateways([FromQuery] GetActiveGatewaysInput input)
        //{
        ...
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_GetPayment)]
        ...
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_GetLastCompletedPayment)]
        ...
        //[HttpPost]
        //[AbpAuthorize(AppPermissions.Pages_Payment_BuyNowSucceed)]
        ...
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_NewRegistrationSucceed)]
        ...
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_UpgradeSucceed)]
        ...
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_ExtendSucceed)]
        ...
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_PaymentFailed)]
        ...
        //[HttpPost]
        //[AbpAuthorize(AppPermissions.Pages_Payment_SwitchBetweenFreeEditions)]
        ...
        //[HttpPost]
        //[AbpAuthorize(AppPermissions.Pages_Payment_UpgradeSubscriptionCostsLessThenMinAmount)]
        ...
        ////[AbpAuthorize(AppPermissions.Pages_Administration_Tenant_SubscriptionManagement)]
        //[HttpGet]
        //[AbpAuthorize(AppPermissions.Pages_Payment_HasAnyPayment)]
