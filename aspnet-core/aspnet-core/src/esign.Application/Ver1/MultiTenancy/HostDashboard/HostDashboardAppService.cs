...
namespace esign.MultiTenancy.HostDashboard.Ver1
{
    ...
    public class HostDashboardAppService : esignVersion1AppServiceBase, IHostDashboardAppService
    {
        ...
        [HttpGet]
        public async Task<TopStatsData> GetTopStatsData([FromQuery] GetTopStatsInput input)
        {
        ...
        [HttpGet]
        public async Task<GetIncomeStatisticsDataOutput> GetIncomeStatistics([FromQuery] GetIncomeStatisticsDataInput input)
        {
        ...
        [HttpGet]
        public async Task<GetEditionTenantStatisticsOutput> GetEditionTenantStatistics([FromQuery] GetEditionTenantStatisticsInput input)
        {
