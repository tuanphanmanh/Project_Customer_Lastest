...
namespace tmss.Common.Ver1
{
    public class Commons
    {
        ...
        private static void SetBorder(ExcelWorksheet v_worksheet, int p_start_rows, int p_start_columns, int p_end_rows, int p_end_columns)
        {
        ...
        private static void SetColorHeader(ExcelWorksheet v_worksheet, int p_start_rows, int p_start_columns, int p_end_rows, int p_end_columns)
        {
