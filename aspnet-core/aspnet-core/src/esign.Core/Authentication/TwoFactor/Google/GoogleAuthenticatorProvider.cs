...
namespace esign.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : esignServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("esign", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
