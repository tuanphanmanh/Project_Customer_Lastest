...
namespace esign.Authorization.Users
{
    public interface IUserEmailer
    {
        ...
        Task<string> SetBodyForSendEmailActive(User user, string link, string plainPassword = null);
        Task<string> SetBodyForSendEmailForgotPassword(User user, string link, string plainPassword = null);
    }
}
