...
{
    public class TB_M_TRANSPORTERInfo
    {
        ...
        public TB_M_TRANSPORTERInfo(int id, int Row_No, string NAME, string ABBREVIATION, string IS_ACTIVE, string CREATED_BY, DateTime CREATED_DATE, string UPDATED_BY, DateTime UPDATED_DATE)
		{
			this.ID = ID;
            this.Row_No = Row_No;
			this.NAME = NAME;
