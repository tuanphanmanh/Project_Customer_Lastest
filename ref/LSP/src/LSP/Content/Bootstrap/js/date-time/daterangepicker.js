...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        updateInputText: function () {
            var isFill = true;
            var startDate = this.startDate.format(this.format);
            var endDate = this.endDate.format(this.format);

            if ($('[name=daterangepicker_start]').val() == '') {
                isFill = false;
                startDate = '01.01.1900';
            } else if ($('[name=daterangepicker_end]').val() == '') {
                isFill = false;
                endDate = '30.12.9999';
            }

            if (this.element.is('input') && !this.singleDatePicker && isFill) {
                this.element.val(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
            } else if (this.element.is('input') && isFill) {
                this.element.val(this.endDate.format(this.format));
            } else {
                this.element.val(startDate + this.separator + endDate);
            }
        },
