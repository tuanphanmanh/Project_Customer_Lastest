...
function runScreenJson() {
    try {
        ...
        $.ajax({
            url: baseUrl + "/TB_R_UNLOADING_PLAN/UNLOADING_MAIN_SCREEN_GETDATA4",
            type: 'GET',
            data: {
            },
            ...
            error: function () {
                console.log("ERROR Request : " + baseUrl + "/TB_R_UNLOADING_PLAN/UNLOADING_MAIN_SCREEN_GETDATA4"); //ex.message && ex.name
                setTimeout("runScreenJson()", 1000);
            }
        });
    } catch (ex) {
