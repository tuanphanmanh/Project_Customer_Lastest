...
function LoadForm() {
    ...
    //resize Width
    w = $(window).width() - 2 - 40;
    w_top = (Math.floor((w / 10) * 100) / 100) - 2;    
    ...
    $(".UNLOADING .TOP_ITEM.TOTAL_QTY .title").css({ "width": w_top * 2 - 10 });
    $(".UNLOADING .TOP_ITEM.TOTAL_QTY .val").css({ "width": w_top * 2});

    $(".UNLOADING .TOP_ITEM.TRUCK_NAME").css({ "width": w_top * 6 });
    $(".UNLOADING .TOP_ITEM.TRUCK_NAME .title").css({ "width": w_top * 2 - 20 });
    $(".UNLOADING .TOP_ITEM.TRUCK_NAME .val2").css({ "width": w_top * 4 + 10});
...
function runScreenJson() {
    ...
    if ((n > 6 || n < 5)) {
        ...
        try {
            ...
            $.ajax({
                url: baseUrl + "/TB_R_CONTENT_LIST/RECEIVING4_GETDATA",
                type: 'GET',
                data: {                    
                },
                ...
                error: function () {
                    ...
                    console.log("ERROR Request : " + baseUrl + "/TB_R_CONTENT_LIST/RECEIVING4_GETDATA"); //ex.message && ex.name
