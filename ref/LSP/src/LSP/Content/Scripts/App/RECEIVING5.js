...
function LoadForm() {
    ...
    $(".UNLOADING .TOP_ITEM.TOTAL_QTY").css({ "width": w_top * 6 });
    $(".UNLOADING .TOP_ITEM.TOTAL_QTY .title").css({ "width": w_top * 3});
    $(".UNLOADING .TOP_ITEM.TOTAL_QTY .val").css({ "width": w_top * 3 - 10});

    $(".UNLOADING .TOP_ITEM.TOTAL_QTY_TRUCK").css({ "width": w_top * 6 });
    $(".UNLOADING .TOP_ITEM.TOTAL_QTY_TRUCK .title").css({ "width": w_top * 3});
    $(".UNLOADING .TOP_ITEM.TOTAL_QTY_TRUCK .val2").css({ "width": w_top * 3 - 10 });

    $(".UNLOADING .TOP_ITEM.TRUCK_NAME").css({ "width": w_top * 8 });
    $(".UNLOADING .TOP_ITEM.TRUCK_NAME .title").css({ "width": w_top * 1.3});
    $(".UNLOADING .TOP_ITEM.TRUCK_NAME .val2").css({ "width": w_top * 6.7 - 10 });
...
function runScreenJson() {
    ...
    if ((n > 6 || n < 5)) {
        ...
        try {
            ...
            $.ajax({
                url: baseUrl + "/TB_R_CONTENT_LIST/RECEIVING5_GETDATA",
                type: 'GET',
                data: {
                },
                ...
                error: function () {
                    ...
                    console.log("ERROR Request : " + baseUrl + "/TB_R_CONTENT_LIST/RECEIVING5_GETDATA"); //ex.message && ex.name
...
function Navigator_Data(jdata, jdataHeader) {
    ...
    $(".TOTAL_QTY_TRUCK .TOP_ITEM_SUB.val2").text(jdataHeader.TRUCK_QTY_REMARK);
    $(".TRUCK_NAME .TOP_ITEM_SUB.val2").text(jdataHeader.TRUCK_NAME);
