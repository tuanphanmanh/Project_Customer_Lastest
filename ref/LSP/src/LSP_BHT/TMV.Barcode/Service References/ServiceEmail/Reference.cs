...
namespace TMV.Barcode.ServiceEmail {
    ...
    public interface EmailServiceSoap {
        ...
        TMV.Barcode.ServiceEmail.SendEmailResponse SendEmail(TMV.Barcode.ServiceEmail.SendEmailRequest request);
    }
    ...
    public partial class SendEmailRequest {
        ...
        public TMV.Barcode.ServiceEmail.SendEmailRequestBody Body;
        
        public SendEmailRequest() {
        }
        
        public SendEmailRequest(TMV.Barcode.ServiceEmail.SendEmailRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendEmailResponse {
        ...
        public TMV.Barcode.ServiceEmail.SendEmailResponseBody Body;
        
        public SendEmailResponse() {
        }
        
        public SendEmailResponse(TMV.Barcode.ServiceEmail.SendEmailResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface EmailServiceSoapChannel : TMV.Barcode.ServiceEmail.EmailServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EmailServiceSoapClient : System.ServiceModel.ClientBase<TMV.Barcode.ServiceEmail.EmailServiceSoap>, TMV.Barcode.ServiceEmail.EmailServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TMV.Barcode.ServiceEmail.SendEmailResponse TMV.Barcode.ServiceEmail.EmailServiceSoap.SendEmail(TMV.Barcode.ServiceEmail.SendEmailRequest request) {
        ...
        public bool SendEmail(string from, string to, string cc, string bcc, string subject, string body, string attachments) {
            TMV.Barcode.ServiceEmail.SendEmailRequest inValue = new TMV.Barcode.ServiceEmail.SendEmailRequest();
            inValue.Body = new TMV.Barcode.ServiceEmail.SendEmailRequestBody();
            ...
            TMV.Barcode.ServiceEmail.SendEmailResponse retVal = ((TMV.Barcode.ServiceEmail.EmailServiceSoap)(this)).SendEmail(inValue);
