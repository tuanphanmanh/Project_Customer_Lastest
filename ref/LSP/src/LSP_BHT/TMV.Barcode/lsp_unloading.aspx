<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lsp_unloading.aspx.cs" Inherits="TMV.Barcode.lsp_unloading" %>
            ...
            <div class="block_scanning">
                ...
                <form class="form" id="frm_scanning" runat="server" method="post" name="frm_scanning"
                    ...
                    <div class="info-box pd">
                        ...
                        <div id="info_area">
                            <div class="info_bar">
                                <div class="lbl_info" id="div_TRUCK" style="width: 70px; display: inline-table;">Truck No.:</div>
                                <div class="lbl_data" id="lbl_TRUCK" runat="server" align ="left"></div>                              
                                <div class="clear"></div>
                            </div>

                            <div class="info_bar" id ="div_STATUS" runat="server" visible="true">
                                <div class="lbl_info" style="width: 70px; display: inline-table;">Status.:</div>
                                <div class="lbl_data" id="lbl_STATUS" runat="server" align ="left"></div>
                                <div class="clear"></div>
                           </div>  
