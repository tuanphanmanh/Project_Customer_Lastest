<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lsp_receiving.aspx.cs" Inherits="TMV.Barcode.lsp_receiving" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function ConfirmDialog_AddAdhoc() {
            if (confirm('Content khong co trong ke hoach, muon them Content nay?')) {
                //True .. do something
                document.getElementById("txtScanValue").value = 'TMV_CONTE_AH_OK';
            ...
            <div class="block_scanning">
                ...
                <form class="form" id="frm_scanning" runat="server" method="post" name="frm_scanning"
                    ...
                    <div class="info-box pd">
                        ...
                        <div id="info_area">
                            <div class="info_bar">
                                <div class="lbl_info" id="div_ORDER" style="width: 75px; display: inline-table;">Order:</div>
                                <div class="lbl_data" id="lbl_ORDER" runat="server" align ="left"></div>                              
                                <div class="clear"></div>
                            </div>

                            <div class="info_bar">
                                <div class="lbl_info" id="lbl_div_PALLET" runat="server" style="width: 75px; display: inline-table;">No of Pallet:</div>
                                <div class="lbl_data" id="lbl_PALLTET_QTY" runat="server" align ="left"></div>                              
                                <div class="clear"></div>
                            </div>

                            <div class="info_bar" id ="div_CONTENT" runat="server" visible="true">
                                <div class="lbl_info" style="width: 75px; display: inline-table;">Content:</div>
