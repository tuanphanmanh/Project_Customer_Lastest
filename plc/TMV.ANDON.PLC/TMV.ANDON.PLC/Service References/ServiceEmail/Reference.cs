...
namespace TMV.ANDON.PLC.ServiceEmail {
    ...
    public interface EmailServiceSoap {
        ...
        TMV.ANDON.PLC.ServiceEmail.SendEmailResponse SendEmail(TMV.ANDON.PLC.ServiceEmail.SendEmailRequest request);
    }
    ...
    public partial class SendEmailRequest {
        ...
        public TMV.ANDON.PLC.ServiceEmail.SendEmailRequestBody Body;
        
        public SendEmailRequest() {
        }
        
        public SendEmailRequest(TMV.ANDON.PLC.ServiceEmail.SendEmailRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendEmailResponse {
        ...
        public TMV.ANDON.PLC.ServiceEmail.SendEmailResponseBody Body;
        
        public SendEmailResponse() {
        }
        
        public SendEmailResponse(TMV.ANDON.PLC.ServiceEmail.SendEmailResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface EmailServiceSoapChannel : TMV.ANDON.PLC.ServiceEmail.EmailServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EmailServiceSoapClient : System.ServiceModel.ClientBase<TMV.ANDON.PLC.ServiceEmail.EmailServiceSoap>, TMV.ANDON.PLC.ServiceEmail.EmailServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TMV.ANDON.PLC.ServiceEmail.SendEmailResponse TMV.ANDON.PLC.ServiceEmail.EmailServiceSoap.SendEmail(TMV.ANDON.PLC.ServiceEmail.SendEmailRequest request) {
        ...
        public bool SendEmail(string from, string to, string cc, string bcc, string subject, string body, string attachments) {
            TMV.ANDON.PLC.ServiceEmail.SendEmailRequest inValue = new TMV.ANDON.PLC.ServiceEmail.SendEmailRequest();
            inValue.Body = new TMV.ANDON.PLC.ServiceEmail.SendEmailRequestBody();
            ...
            TMV.ANDON.PLC.ServiceEmail.SendEmailResponse retVal = ((TMV.ANDON.PLC.ServiceEmail.EmailServiceSoap)(this)).SendEmail(inValue);
