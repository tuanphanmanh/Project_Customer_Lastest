...
import { LinkAnnotationService, BookmarkViewService, MagnificationService, ThumbnailViewService, ToolbarService, NavigationService, TextSearchService, TextSelectionService, PrintService, AnnotationService, FormFieldsService, FormDesignerService, ContextMenu } from '@syncfusion/ej2-angular-pdfviewer';
import { ContextMenuModule } from '@syncfusion/ej2-angular-navigations';
import { EditService, PageService, ResizeService } from '@syncfusion/ej2-angular-grids';
...
import { NotificationService } from './shared/layout/notifications/notification.service';
...
@NgModule({
    ...
    providers: [
        ...
        LinkAnnotationService, MagnificationService, ThumbnailViewService, ToolbarService, NavigationService,
        TextSearchService, TextSelectionService, PrintService, AnnotationService, FormFieldsService, FormDesignerService,ResizeService,PageService,EditService
    ],
    imports: [
        CommonModule,
        FormsModule,
