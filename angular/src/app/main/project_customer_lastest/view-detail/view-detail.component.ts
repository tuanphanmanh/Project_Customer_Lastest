...
export class ViewDetailComponent extends AppComponentBase implements OnInit {
    ...
    backPage() {
        ...
        // window.location.href = '/app/main/document-management?requestid=' + this.referenceRequest.id.toString();
    }
