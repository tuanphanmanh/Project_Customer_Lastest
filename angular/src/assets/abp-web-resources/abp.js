...
(function () {
    ...
    abp.log.log = function (logObject, logLevel) {
        ...
        if(logObject) {
            ...
            switch(logObject?.code) {
                case 268: // không có chữ kí số
                    localStorage.setItem("CODE_268", JSON.stringify(logObject));
                    // this.local.setItem("CODE_268", logObject);
                    break;
                case 269: // chữ kí số hết hạn
                    localStorage.setItem("CODE_269", JSON.stringify(logObject));
                    // this.local.setItem("CODE_268", logObject);
                    break;
                default: 
                    break;
